...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ type table of ztb_acc_categ_81,
       lt_catego    type table of ztb_catego_8191,
       lt_clientes  type table of ztb_clientes_819,
       lt_clnts_lib type table of ztb_clnts_lib_81,
       lt_libros    type table of ztb_libros_8191.
...
******** TABLA1 ********
    ...
    delete from ztb_acc_categ_81.
    insert ztb_acc_categ_81 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_8191.
    insert ztb_catego_8191 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_819.
    insert ztb_clientes_819 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_81.
    insert ztb_clnts_lib_81 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_8191.
    insert ztb_libros_8191 from table @lt_libros.
